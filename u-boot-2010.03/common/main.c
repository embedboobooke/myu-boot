...
{
	printf("***************************************************\n");     
	printf("***    华东交通大学嵌入式实验室  2012.06.10     ***\n");
	printf("***        u-boot-2010.03 V1.0 终极版           ***\n");
	printf("***  For mickey2440   balabala.feet@gmail.com   ***\n");
	printf("***      祝各位在嵌入式的海洋尽情施展绝技       ***\n");
	if (bBootFrmNORFlash == 1)
	printf("***             启动方式:NorFlash               ***\n");
	else
	printf("***            启动方式:NandFlash               ***\n");
	printf("***************************************************\n");
}
/*mickeyos add end*/
